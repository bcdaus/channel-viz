(function ( $ ){
	...
	*/
	...
	var defaultKey		= '5jJRISSCxTXUFxWxJ0nCHpWlSmNfC5q6xXw2XX8zQaJxLGbH', // Unique master Xively API key to be used as a default
		defaultFeeds	= [867545550], // Comma separated array of Xively Feed ID numbers
		applicationName	= '', // Replaces Xively logo in the header
		dataDuration	= '0', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
